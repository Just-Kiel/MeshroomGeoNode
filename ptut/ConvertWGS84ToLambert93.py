...
class ConvertWGS84ToLambert93(desc.CommandLineNode):
    commandLine = 'python ./lib/meshroom/nodes/scripts/convertWgs84ToLambert93.py {methodValue} {GPSFileValue} {latInputPointValue} {lonInputPointValue} {outputValue}'
...
'''
    ...
    outputs = [
        desc.File(
            ...
            label='Output',
            description='''Output.''',
            value= desc.Node.internalFolder + "lambert93.json",
            uid=[0],
        ),
    ]